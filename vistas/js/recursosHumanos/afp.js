...
function agregarDatos(){
      ...
      $.ajax({
          url:"../api_adm_nortrans/afp/funAgregar.php",
          method:"POST",
          cache: false,
...
function obtenerDatosParaModificar(valor){
      ...
      $.ajax({
          url:"../api_adm_nortrans/afp/funDatosParaModificar.php",
          method:"POST",
          cache: false,
          data: JSON.stringify(params),
          contentType: false,
...
function modificarDatos(){
      ...
      $.ajax({
          url:"../api_adm_nortrans/afp/funModificar.php",
          method:"POST",
          cache: false,
          data: JSON.stringify(params),
          contentType: false,
...
function eliminarDatos(valor){
      ...
      $.ajax({
          url:"../api_adm_nortrans/afp/funEliminar.php",
          method:"POST",
          cache: false,
          data: JSON.stringify(params),
          contentType: false,
