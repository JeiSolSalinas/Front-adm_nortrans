...
function agregarDatos(){
      ...
      $.ajax({
          url:"../api_adm_nortrans/antecedentesMedicos/funAgregar.php",
          method:"POST",
          cache: false,
...
function obtenerDatosParaModificar(valor){
      ...
      $.ajax({
          url:"../api_adm_nortrans/antecedentesMedicos/funDatosParaModificar.php",
          method:"POST",
          cache: false,
          data: JSON.stringify(params),
          contentType: false,
...
function modificarDatos(){
      ...
      $.ajax({
          url:"../api_adm_nortrans/antecedentesMedicos/funModificar.php",
          method:"POST",
          cache: false,
          data: JSON.stringify(params),
          contentType: false,
...
function eliminarDatos(valor){
      ...
      $.ajax({
          url:"../api_adm_nortrans/antecedentesMedicos/funEliminar.php",
          method:"POST",
          cache: false,
          data: JSON.stringify(params),
          contentType: false,
