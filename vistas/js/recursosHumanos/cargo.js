$(document).ready(function (){
  ...
  function agregarDatos(){
        ...
        $.ajax({
            url:"../api_adm_nortrans/cargo/funAgregar.php",
            method:"POST",
            cache: false,
  ...
  function obtenerDatosParaModificar(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/cargo/funDatosParaModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
  ...
  function modificarDatos(){
        ...
        $.ajax({
            url:"../api_adm_nortrans/cargo/funModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
  ...
  function eliminarDatos(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/cargo/funEliminar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
