$(document).ready(function (){
  ...
  function cargarDatosTabla(){
        ...
        var fila = "";
        $.ajax({
            url:"../api_adm_nortrans/contactoParentesco/funListar.php",
            method:"GET",
            cache: false,
            contentType: false,
            processData: false,
  ...
  function agregarDatos(){
        var params = {
                          "descripcion": $("#descricontactoParentesco").val()
                     };
        $.ajax({
            url:"../api_adm_nortrans/contactoParentesco/funAgregar.php",
            method:"POST",
            cache: false,
  ...
  function obtenerDatosParaModificar(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/contactoParentesco/funDatosParaModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
            ...
            success: function(response) {
                for (var i in response){
                    $("#contactoParentescoModificar").val(response[i].descripcion);
                    $("#idcontactoParentescoModificar").val(response[i].id);
                }  
  ...
  function modificarDatos(){
        var params = {
                          "descripcion": $("#contactoParentescoModificar").val(),
                          "id": $("#idcontactoParentescoModificar").val()
                     };
        $.ajax({
            url:"../api_adm_nortrans/contactoParentesco/funModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
  ...
  function eliminarDatos(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/contactoParentesco/funEliminar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
