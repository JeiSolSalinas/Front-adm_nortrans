...
function agregarDatos(){
      ...
      $.ajax({
          url:"../api_adm_nortrans/documento/funAgregar.php",
          method:"POST",
          cache: false,
...
function obtenerDatosParaModificar(valor){
      ...
      $.ajax({
          url:"../api_adm_nortrans/documento/funDatosParaModificar.php",
          method:"POST",
          cache: false,
          data: JSON.stringify(params),
          contentType: false,
...
function modificarDatos(){
      ...
      $.ajax({
          url:"../api_adm_nortrans/documento/funModificar.php",
          method:"POST",
          cache: false,
          data: JSON.stringify(params),
          contentType: false,
...
function eliminarDatos(valor){
      ...
      $.ajax({
          url:"../api_adm_nortrans/documento/funEliminar.php",
          method:"POST",
          cache: false,
          data: JSON.stringify(params),
          contentType: false,
