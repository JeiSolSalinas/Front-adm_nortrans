$(document).ready(function (){
  ...
  function agregarDatos(){
        var params = {
                          "descripcion": $("#descripcionAnexo").val()
                     };
        $.ajax({
            url:"../api_adm_nortrans/tipoAnexo/funAgregar.php",
            method:"POST",
            cache: false,
  ...
  function obtenerDatosParaModificar(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/tipoAnexo/funDatosParaModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
            ...
            success: function(response) {
                for (var i in response){
                    $("#descripcionAnexoModificar").val(response[i].descripcion);
                    $("#idAnexoModificar").val(response[i].id);
                }  
  ...
  function modificarDatos(){
        var params = {
                          "descripcion": $("#descripcionAnexoModificar").val(),
                          "id": $("#idAnexoModificar").val()
                     };
        $.ajax({
            url:"../api_adm_nortrans/tipoAnexo/funModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
  ...
  function eliminarDatos(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/tipoAnexo/funEliminar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
