$(document).ready(function (){
  ...
  function agregarDatos(){
        var params = {
                          "descripcion": $("#descripcionEstudio").val()
                     };
        $.ajax({
            url:"../api_adm_nortrans/tipoEstudio/funAgregar.php",
            method:"POST",
            cache: false,
  ...
  function obtenerDatosParaModificar(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/tipoEstudio/funDatosParaModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
            ...
            success: function(response) {
                for (var i in response){
                    $("#descripcionEstudioModificar").val(response[i].descripcion);
                    $("#idEstudioModificar").val(response[i].id);
                }  
  ...
  function modificarDatos(){
        var params = {
                          "descripcion": $("#descripcionEstudioModificar").val(),
                          "id": $("#idEstudioModificar").val()
                     };
        $.ajax({
            url:"../api_adm_nortrans/tipoEstudio/funModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
  ...
  function eliminarDatos(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/tipoEstudio/funEliminar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
