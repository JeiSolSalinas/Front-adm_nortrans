$(document).ready(function (){
  ...
  function cargarDatosTabla(){
        ...
        var fila = "";
        $.ajax({
            url:"../api_adm_nortrans/tipoTerminoContrato/funListar.php",
            method:"GET",
            cache: false,
            contentType: false,
            processData: false,
  ...
  function agregarDatos(){
        var params = {
                          "descripcion": $("#descripcionTerminoContrato").val()
                     };
        $.ajax({
            url:"../api_adm_nortrans/tipoTerminoContrato/funAgregar.php",
            method:"POST",
            cache: false,
  ...
  function obtenerDatosParaModificar(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/tipoTerminoContrato/funDatosParaModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
            ...
            success: function(response) {
                for (var i in response){
                    $("#terminoContratoModificar").val(response[i].descripcion);
                    $("#idterminoContratoModificar").val(response[i].id);
                }  
  ...
  function modificarDatos(){
        var params = {
                          "descripcion": $("#terminoContratoModificar").val(),
                          "id": $("#idterminoContratoModificar").val()
                     };
        $.ajax({
            url:"../api_adm_nortrans/tipoTerminoContrato/funModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
  ...
  function eliminarDatos(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/tipoTerminoContrato/funEliminar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
