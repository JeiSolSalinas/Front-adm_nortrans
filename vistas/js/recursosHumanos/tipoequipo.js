$(document).ready(function (){
  ...
  function agregarDatos(){
        ...
        $.ajax({
            url:"../api_adm_nortrans/tipoequipo/funAgregar.php",
            method:"POST",
            cache: false,
  ...
  function obtenerDatosParaModificar(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/tipoequipo/funDatosParaModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
  ...
  function modificarDatos(){
        ...
        $.ajax({
            url:"../api_adm_nortrans/tipoequipo/funModificar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
  ...
  function eliminarDatos(valor){
        ...
        $.ajax({
            url:"../api_adm_nortrans/tipoequipo/funEliminar.php",
            method:"POST",
            cache: false,
            data: JSON.stringify(params),
            contentType: false,
