<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Administrar Centro de Costo
    
    </h1>

    <ol class="breadcrumb">
      
      <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio/Generaless</a></li>
      
      <li class="active">Administrar Centro de Costo</li>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="form-group col-sm-3 col-xs-12 ">
          <button class="btn btn btn-block btn-success" data-toggle="modal" data-target="#modalAgregar" id="btnAgregarRegistro">          
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-12 col-xs-12">                 
              <label for="seleccionEmpresaAgregar">Empresa:</label>
              <select class="form-control input-md cajatexto js-example-basic-single" id="seleccionEmpresaAgregar" name="seleccionEmpresaAgregar"></select>
            </div>
      ...
      <form role="form" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-12 col-xs-12">                 
              <label for="seleccionEmpresaModificar">Empresa:</label>
              <select class="form-control input-md cajatexto js-example-basic-single" id="seleccionEmpresaModificar" name="seleccionEmpresaModificar"></select>
            </div>
...
<script src="vistas/js/generales/centroDeCosto.js"></script>
