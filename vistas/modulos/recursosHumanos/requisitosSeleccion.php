<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>
      ...
      Administrar Requisitos de Seleccion
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar Requisitos de Seleccion</li>
...
<script src="vistas/js/recursosHumanos/requisitosSeleccion.js"></script>
