<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar Tipo Anexo</li>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
                <label for="descripcionAnexo">Descripción:</label>
                <input type="text" class="form-control input-md" name="descripcionAnexo" id="descripcionAnexo" placeholder="Ingresar Descripción" required>
            </div>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-12 col-xs-12">
                <label for="descripcionAnexoModificar">Descripción:</label>
                <input type="text" class="form-control input-md" name="descripcionAnexoModificar" id="descripcionAnexoModificar" required>
                <input type="hidden"  name="idAnexoModificar" id="idAnexoModificar" required>
            </div>
...
<script src="vistas/js/recursosHumanos/tipoAnexo.js"></script>
