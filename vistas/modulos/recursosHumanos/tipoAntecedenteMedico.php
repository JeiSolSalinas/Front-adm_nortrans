<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar Tipo Antecedente Medico</li>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control input-md" name="descripcionAnteMedico" id="descripcionAnteMedico" placeholder="Ingresar Descripción" required>
            </div>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-12 col-xs-12">
                <label for="nuevoNombre">Descripción:</label>
                <input type="text" class="form-control input-md" name="antecedenteMedicoModificar" id="antecedenteMedicoModificar" required>
                <input type="hidden"  name="idAntecedenteMedico" id="idAntecedenteMedico" required>
            </div>
...
<script src="vistas/js/recursosHumanos/tipoAntecedenteMedico.js"></script>
