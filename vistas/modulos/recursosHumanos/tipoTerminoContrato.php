<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar Tipo Termino de Contrato</li>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
                <label for="descripcionTerminoContrato">Descripción:</label>
                <input type="text" class="form-control input-md" name="descripcionTerminoContrato" id="descripcionTerminoContrato" placeholder="Ingresar Descripción" required>
            </div>
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group col-sm-12 col-xs-12">
                <label for="terminoContratoModificar">Descripción:</label>
                <input type="text" class="form-control input-md" name="terminoContratoModificar" id="terminoContratoModificar" required>
                <input type="hidden"  name="idterminoContratoModificar" id="idterminoContratoModificar" required>
            </div>
...
<script src="vistas/js/recursosHumanos/tipoTerminoContrato.js"></script>
